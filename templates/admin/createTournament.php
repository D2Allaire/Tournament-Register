    ...
    <main class="admin tableview">
        <div class="container main">
            ...
            <?php if ( isset( $_GET['status'] ) ) {
                ...
                <?php } }?>
            <div class="row">
                <form class="col s12" method="post" action="<?php echo TEMPLATE_PATH?>/admin/save.php?type=tournament&create=true" enctype="multipart/form-data">
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s4">
                            <input id="format" name="format" type="text" class="validate" length="20">
